...
describe UsersController do
  ...
  def valid_attributes
    { "name" => "My Name", "email" => "myname@test.net", "password" => "password" }
  end
  ...
  describe "GET index" do
    it "assigns all users as @users", solr: true do
      user = User.create! valid_attributes
      get :index, {}, valid_session
      assigns(:users).should eq([User.first, user])
    end

    it "fulltext search 'word'" do
      get :index, {search: "word"}, valid_session
      Sunspot.session.should be_a_search_for(User)
      Sunspot.session.should have_search_params(:fulltext, "word")
